...
exports.bookinstance_update_post = [
    ...
    body('due_back', 'Due date is invalid.').optional({ checkFalsy: true }).isISO8601(),
    ...
    (req, res, next) => {
        ...
        if (!errors.isEmpty()) {
            Book.find({},'title')
                .exec(function (err, books) {
                    if (err) { return next(err); }
                    res.render('bookinstance_form', { title: 'Update BookInstance', book_list: books, selected_book: bookinstance.book._id , 
